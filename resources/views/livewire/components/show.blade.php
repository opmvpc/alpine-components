<x-layouts.container>
    ...
    <div class="flex justify-between items-end mb-6">
        <div class="inline-flex justify-between items-end ">
            <h1 class="text-2xl font-extrabold">{{ $alpineComponent->category->name}}</h1>
        ...
        <a class="inline-flex items-center font-extrabold mt-4 transform hover:-translate-x-2 transition-transform duration-200 ease-in-out" href="{{route('components.index') }}">
            <svg class="inline h-4 w-4 mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="mb-4 flex justify-between items-end">
                    ...
                    <div class="inline-flex items-end">
                        <form action="https://codepen.io/pen/define" method="POST" target="_blank">
                            ...
                            <button class="bg-yellow-200 border-2 border-yellow-400 text-yellow-700 px-4 py-2 rounded-lg text-sm font-bold" type="submit">
                                Codepen
                            </button>
                        </form>
                    </div>
    ...
    @foreach ($alpineComponent->files as $file)
        <div x-data="{...copyButton(), ...codeArea()}">
            ...
            <div class="mb-4 flex justify-between items-end">
                ...
                <div class="inline-flex items-end">
                    <button @click="copy" class="bg-yellow-200 border-2 border-yellow-400 text-yellow-700 px-4 py-2 rounded-lg text-sm font-bold" x-bind:class="{'bg-green-200': isCopied, 'border-green-400': isCopied, 'text-green-700': isCopied}">
